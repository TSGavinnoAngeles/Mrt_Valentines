  ...
  <div className="bg-white ">
    ...
    <div className='px-12 min-h-min overflow-x-auto'>
      <div className="flex mb-2 space-x-2 ">
        ...
        <div> 
        <button type="submit" className="text-white bg-[#050708] hover:bg-[#050708]/90 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-[#050708]/50 dark:hover:bg-[#050708]/30 me-2 mb-2 self-center object-right-top" 
            onClick={
              // handleUpdate
        ...
        <div className= "" onDrop={handleOnDrop} onDragOver={handleDragOver} style={{ marginTop: "40px", padding: "10px", border: "2px dashed black" , width: "660px", height:"350px"}}>
        <form>

          <div className="mb-3 md:grid-cols-2">
            
            <div className='relative'>
              <label className="block mb-4 text-sm font-medium text-black-900 dark:text-black">Insert ID</label>
              <input
                readOnly
      ...
      <div className ="rounded-mb bg-red-700" onClick={() => handleButtonClick(delWidgets)} 
            onDrop={deleteOnDrop} onDragOver={handleDragOverDelete} style={{ marginTop: "10px", padding: "10px" , width: "710", height:"100px"}}>
                <h1><p className="text-6xl text-center font-semibold text-blue-50 dark:text-maroon-500/100 ">{delWidgets}</p></h1>
